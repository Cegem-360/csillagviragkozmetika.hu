...
<html lang="hu">
    ...
    <head>
        ...
        <script>
            ...
            })(window, document, 'script', 'dataLayer', 'GTM-PC739ZX6');
        </script>
        ...
        <meta name="description"
            content="Balatoni Marianna kozmetikus — professzionális arckezelések, gépi kezelések, GIGI és Ilcsi termékekkel. 1196 Kispest, Batthyány u. 126.">
        <meta name="keywords"
            content="kozmetika, arckezelés, Kispest, Budapest, GIGI, Ilcsi, Balatoni Marianna, szépségszalon">
        ...
        <meta property="og:description"
            content="Balatoni Marianna kozmetikus — professzionális arckezelések, gépi kezelések, GIGI és Ilcsi termékekkel.">
    ...
    <body class="bg-cream">
        ...
        <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PC739ZX6" height="0" width="0"
